  ...
  return (
    <>
      <div className="mb-10">
        ...
        <p className="text-gray-600">Sign in to continue your winning streak</p>
      </div>
      ...
      <form className="space-y-6">
        ...
        <div>
          ...
          <div className="relative">
            <input
              id="password"
              name="password"
              className="w-full px-4 py-3 pl-12 pr-12 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#00CED1] focus:border-transparent transition-all duration-200 bg-white/50 backdrop-blur-sm"
        ...
        <div className="flex items-center justify-between">
          ...
          <Link
            className="text-sm font-medium text-[#00CED1] hover:text-[#00CED1]/80 underline"
            href="/reset-password"
          >
            Forgot password?
          </Link>
