        ...
        <div className="max-w-md mx-auto space-y-6 pt-6">
          ...
          <div className="bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-md border border-slate-700/50 rounded-2xl p-6 shadow-2xl">
            <div className="flex items-start justify-between mb-6">
              <h3 className="text-white font-bold text-lg">Faucet</h3>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-blue-400 rounded-full animate-pulse"></div>
                <span className="text-sm text-blue-400">For Testing</span>
              </div>
            </div>
            ...
            <button
              ...
              className="relative w-full bg-gradient-to-r from-emerald-400 to-green-500 hover:from-emerald-500 hover:to-green-600 disabled:from-slate-600 disabled:to-slate-700 text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-[1.02] shadow-lg overflow-hidden group disabled:cursor-not-allowed disabled:transform-none"
            >
              {isFaucetLoading && (
              ...
              <span className="relative z-10">{isFaucetLoading ? 'Getting Token...' : 'Get 1 Token'}</span>
            </button>
          </div>
